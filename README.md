...
```javascript
uncurryRight = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-uncurry-right@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-uncurry-right@umd/bundle.js"></script>
```
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-curry-right@umd/bundle.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-uncurry-right@umd/bundle.js"></script>
<script type="text/javascript">
(function () {
